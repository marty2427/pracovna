...
export const MATERIALY: Material[] = [
  {
    id: 'dub-svetly-masiv', nazev: 'Dub masiv, světlý (olej)', kategorie: 'masiv',
  ...
  {
    id: 'dub-podlaha-masiv', nazev: 'Dub masiv, mořený do tónu podlahy', kategorie: 'masiv',
  ...
  {
    id: 'lino-antracit', nazev: 'Linoleum na nábytek, antracit', kategorie: 'linoleum',
    barva: '#3A3A3A', drevo: false, drsnost: 0.72, lesk: 0.06, tloustky: [19, 25, 30],
  },
  {
    id: 'lak-petrolej', nazev: 'Lakovaná MDF, petrolej (tón gauče)', kategorie: 'lak',
    barva: K.gauc_zaklad, drevo: false, drsnost: 0.45, lesk: 0.35, tloustky: [18, 25],
    poznamka: 'Namícháno na petrolej gauče.',
  },
  {
    id: 'lak-horcicova', nazev: 'Lakovaná MDF, hořčicová (tón obrazu)', kategorie: 'lak',
